...
import com.KartikeySingh.project.UberApp.Uber_Cl.services.*;
...
public class DriverServiceImpl implements DriverService {
    ...
    public RideDTO startRide(Long rideId,String otp) {
        ...
        if (!ride.getRideStatus().equals(RideStatus.CONFIRMED)) {
            throw new RuntimeException("Ride status has not CONFIRMED hence cannot be started, status:" + ride.getRideStatus());
        }
